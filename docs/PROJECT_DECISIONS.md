...
- Jeder Spielabschnitt verwendet eines der getrennt gespeicherten Formate „1 Satz“, „2 Sätze“, „2 Sätze + Match-Tiebreak“ oder „3 Sätze“. Paarung und Format stehen in einer gemeinsamen Kopfzeile; darunter werden dieselben leeren, schrittweise bedienbaren und live validierten Counter wie bei Ligaergebnissen angezeigt. Eine freie Ergebniseingabe und eine manuelle Statusauswahl gibt es nicht mehr. Das Format bestimmt die Zahl der regulären Satz-Counter; ein Match-Tiebreak wird erst nach zwei vollständig beendeten, geteilten Sätzen aktiv.
