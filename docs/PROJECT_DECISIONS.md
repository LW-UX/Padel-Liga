...
- Das Widget „Vergangene Partien“ zeigt Liga- und Trainingspartien gemeinsam als ungefilterte, chronologische Liste. Mehrere Partner beziehungsweise Gegner werden wie im Spielplan durch ein graues `&` statt durch einen Schrägstrich getrennt. Standardmäßig sind die zehn neuesten Partien sichtbar. Ab elf Partien erscheint darunter ein sekundärer Button, der die vollständige Historie einblendet.
